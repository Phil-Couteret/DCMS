// Data Breach Tracking Service for GDPR Article 33-34 Compliance
 ...
 */
export const getBreachesRequiringCustomerNotification = async () => {
  try {
    const response = await fetch(`${API_BASE_URL}/breaches/requiring-customer-notification`, {
      method: 'GET',
      headers: { 'Content-Type': 'application/json' },
    });
    ...
    console.error('[Breach Service] Error fetching breaches requiring notification:', error);
    return [];
  }
};
...
const breachService = {
  ...
  getBreachStatistics,
  getOverdueBreaches,
  getBreachesRequiringCustomerNotification,
  getBreach,
  updateBreachStatus,
