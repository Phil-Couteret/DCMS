...
const Home = () => {
  ...
  const paymentOptions = [
    { cycle: 'platformPrice.monthly', label: 'platformPrice.noDiscount' },
    { cycle: 'platformPrice.quarterly', label: 'platformPrice.discount5' },
    { cycle: 'platformPrice.semester', label: 'platformPrice.discount8' },
    { cycle: 'platformPrice.yearly', label: 'platformPrice.discount15' }
  ];
  ...
  return (
    <Box>
      ...
      <Box sx={{ bgcolor: 'primary.main', color: 'white', py: 10 }}>
        <Container>
          <Typography variant="h2" component="h1" gutterBottom fontWeight="bold" sx={{ fontSize: { xs: '2.5rem', md: '3rem' } }}>
            DCMS
          </Typography>
      ...
      {/* Plans / Pricing */}
      <Box sx={{ bgcolor: '#f5f5f5', py: 8 }} id="pricing">
        <Container>
          <Typography variant="h4" gutterBottom textAlign="center" fontWeight="bold">
      ...
      <Container sx={{ py: 6 }}>
        ...
        <TableContainer component={Paper} variant="outlined" sx={{ overflowX: 'auto' }}>
          <Table size="small">
            ...
            <TableBody>
              <TableRow><TableCell>{t('platformPrice.locations')}</TableCell><TableCell align="center">1</TableCell><TableCell align="center">3</TableCell><TableCell align="center">∞</TableCell></TableRow>
              <TableRow><TableCell>{t('platformPrice.diveSites')}</TableCell><TableCell align="center">10</TableCell><TableCell align="center">30</TableCell><TableCell align="center">∞</TableCell></TableRow>
              <TableRow><TableCell>{t('platformPrice.boats')}</TableCell><TableCell align="center">5</TableCell><TableCell align="center">15</TableCell><TableCell align="center">∞</TableCell></TableRow>
              <TableRow><TableCell>{t('platformPrice.users')}</TableCell><TableCell align="center">5</TableCell><TableCell align="center">15</TableCell><TableCell align="center">∞</TableCell></TableRow>
              <TableRow><TableCell>{t('platformPrice.customers')}</TableCell><TableCell align="center">200</TableCell><TableCell align="center">1 000</TableCell><TableCell align="center">∞</TableCell></TableRow>
              <TableRow><TableCell>{t('platformPrice.storage')}</TableCell><TableCell align="center">2 GB</TableCell><TableCell align="center">5 GB</TableCell><TableCell align="center">10 GB</TableCell></TableRow>
              <TableRow><TableCell>{t('platformPrice.partners')}</TableCell><TableCell align="center">1</TableCell><TableCell align="center">5</TableCell><TableCell align="center">∞</TableCell></TableRow>
              <TableRow><TableCell>{t('platformPrice.support')}</TableCell><TableCell align="center">Email</TableCell><TableCell align="center">Email + WhatsApp</TableCell><TableCell align="center">{t('platformPrice.prioritySupport')}</TableCell></TableRow>
            </TableBody>
          </Table>
        </TableContainer>
      </Container>
