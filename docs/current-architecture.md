...
*(Updated 2026-08-10 — Phase 5.2 and Phase 6.5 split the largest page files into `hooks/` + presentational components; Phase 6.6 and 6.10 added test coverage and route-based code splitting. This section previously described the pre-split, zero-test state; it's now current.)*
