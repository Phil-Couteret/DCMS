...
| public-website | React + MUI, Create React App | React ^18.2.0, react-scripts 5.0.1 (deprecated) — not yet migrated to Vite, see `docs/roadmap.md` item 18 |
